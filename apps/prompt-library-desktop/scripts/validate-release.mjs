...
const catalogIndex = JSON.parse(fs.readFileSync(path.join(catalogRoot, "manifest.json"), "utf8"));
...
if (mediaManifest && mediaManifest.catalog_case_count !== catalog.cases.length) {
  errors.push(`media manifest catalog_case_count=${mediaManifest.catalog_case_count}, catalog cases=${catalog.cases.length}`);
}
